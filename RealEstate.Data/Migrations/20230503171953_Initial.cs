        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddres = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddress = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Propertie__Prope__74AE54BC",
                        column: x => x.PropertyType,
                        principalTable: "PropertyTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Propertie__Trans__72C60C4A",
                        column: x => x.TransactionType,
                        principalTable: "TransactionsTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Propertie__UserI__73BA3083",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__PropertyI__Prope__778AC167",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    PropertyId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    RentPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Transacti__Buyer__2DE6D218",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transacti__Owner__2CF2ADDF",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transacti__Prope__2EDAF651",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transacti__Trans__2FCF1A8A",
                        column: x => x.TransactionType,
                        principalTable: "TransactionsTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_TransactionType",
                table: "Properties",
